...
import time
import requests
from apps.home.libs.CMSeeK.VersionDetect import detect as version_detect


from apps.home.libs.CMSeeK.deepscans import core as advanced # Deep scan and Version Detection functions
from apps.home.libs.CMSeeK.cmseekdb import basic as cmseek # All the basic functions
from apps.home.libs.CMSeeK.cmseekdb import sc as source # Contains function to detect cms from source code
from apps.home.libs.CMSeeK.cmseekdb import header as header # Contains function to detect CMS from gathered http headers
from apps.home.libs.CMSeeK.cmseekdb import cmss as cmsdb # Contains basic info about the CMSs
from apps.home.libs.CMSeeK.cmseekdb import dirscheck as dirscheck # Containts function to detect CMS by directory checks
from apps.home.libs.CMSeeK.cmseekdb import robots as robots
from apps.home.libs.CMSeeK.cmseekdb import generator as generator
from apps.home.libs.CMSeeK.cmseekdb import result as result

def main_proc(site,cua,test_id):
    ...
    if cms_detected == '1':
        ...
        if cms_info['deeps'] == '1' and not cmseek.light_scan and not cmseek.only_cms:
            ...
            result.end(str(cmseek.total_requests), str(comptime), log_file,test_id)
            '''
